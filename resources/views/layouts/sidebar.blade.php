...
@php
    ...
    $auth = auth()->user();
    $isSuperadmin = optional($auth->role)->name === 'superadmin';
    $department = $department ?? null;

    $menuGroups = $isSuperadmin
        ? SuperadminMenuHelper::getMenuGroups($department)
        : MenuHelper::getMenuGroups($department);
...
<aside id="sidebar"
    ...
    <div class="pt-8 pb-7 flex"
     ...
     class="dark:hidden h-10 w-auto" src="/images/logo/logo.jpg" alt="Logo" />
<img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
     class="hidden dark:block h-10 w-auto" src="/images/logo/logo.jpg" alt="Logo" />
<img x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
     class="h-8 w-8" src="/images/logo/logo.jpg" alt="Logo" />
