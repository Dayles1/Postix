                        ...
                        <footer class="mt-5">
                            @if (!$isDeleted)
                                <a href="{{ route('departments.show', $d->id) }}"
                                    class="block w-full text-center sm:w-auto sm:inline-flex items-center px-5 py-2.5 rounded-2xl border border-gray-200 text-sm hover:bg-gray-50 font-medium">
                        ...
                        @if(!$free)
                            <div x-show="modalMode === 'create'">
                                ...
                                <input type="text" name="ban_starts_at" id="ban_starts_at"
                                    ...
                                    class="mt-1 h-11 w-full rounded-2xl border px-4 bg-transparent border-gray-200 dark:border-gray-700" />
                                <p class="mt-1 text-xs text-gray-500">
                                    Shu sana kirgandan keyin department avtomatik ban bo‘ladi.
                                </p>
                            </div>
                        @endif
