        ...
        <div class="rounded-2xl bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700 p-4 md:p-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                <h1 class="text-xl font-semibold text-gray-900 dark:text-white">
                    {{ __('messages.warehouse.turkey') }}
                </h1>

            </div>

            <form method="GET" action="{{ route('warehouse.turkey') }}" class="grid grid-cols-1 md:grid-cols-6 gap-3 mb-6">

                <input type="text" name="input_sequence_number" value="{{ request('input_sequence_number') }}"
                    placeholder="{{ __('messages.warehouse.input_sequence_number') }}"
                ...
                <input type="text" name="entrance" value="{{ request('entrance') }}"
                    placeholder="{{ __('messages.warehouse.entrance') }}"
                    class="border border-gray-300 dark:border-gray-600 rounded px-3 py-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400">
                    ...
                    <thead class="bg-gray-100 dark:bg-gray-800">
                        <tr>
                            <th
                                ...
                                {{ __('messages.warehouse.id') }}
                            </th>
                            <th
                                class="text-left px-4 py-3 border-b border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-200">
                                {{ __('messages.warehouse.ordinal_number') }}
                            </th>
                            <th
                                class="text-left px-4 py-3 border-b border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-200">
                                {{ __('messages.warehouse.input_sequence_number') }}
                            </th>
                            <th
                                class="text-left px-4 py-3 border-b border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-200">
                                {{ __('messages.warehouse.car_number') }}
                            </th>
                            <th
                                class="text-left px-4 py-3 border-b border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-200">
                                {{ __('messages.warehouse.phone') }}
                            </th>
                            <th
                                class="text-left px-4 py-3 border-b border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-200">
                                {{ __('messages.warehouse.date') }}
                            </th>
                            <th
                                class="text-left px-4 py-3 border-b border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-200">
                                {{ __('messages.warehouse.entrance') }}
                            </th>
                            <th
                                class="text-left px-4 py-3 border-b border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-200">
                                {{ __('messages.warehouse.company_name') }}
                            </th>
                        </tr>
                    </thead>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse($items as $item)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                                ...
                                <td class="px-4 py-3 text-gray-800 dark:text-gray-200">{{ $item['ordinal_number'] ?? '-' }}
                                </td>
                                <td class="px-4 py-3 text-gray-800 dark:text-gray-200">
                                    {{ $item['input_sequence_number'] ?? '-' }}</td>
                                <td class="px-4 py-3 text-gray-800 dark:text-gray-200">{{ $item['car_number'] ?? '-' }}
                                </td>
                                <td class="px-4 py-3 text-gray-800 dark:text-gray-200">{{ $item['phone'] ?? '-' }}</td>
                                <td class="px-4 py-3 text-gray-800 dark:text-gray-200">{{ $item['date'] ?? '-' }}</td>
                                <td class="px-4 py-3 text-gray-800 dark:text-gray-200">{{ $item['entrance'] ?? '-' }}</td>
